...
func main() {
    ...
    response := client.updateUserBatch(
      dto.UpdateUserBatchReqDto {
        List: []UpdateUserInfoDto{
            ...
            Formatted: "",
            Region: "",
            CustomData: dto.UpdateUserInfoDto {    school="北京大学",    age=22,},
                }
                  },
        Options: dto.UpdateUserBatchOptionsDto {
