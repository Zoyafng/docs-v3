...
func main() {
    ...
    response := client.addApplicationPermissionRecord(
      dto.AddApplicationPermissionRecord {
          AppId: "6229ffaxxxxxxxxcade3e3d9",
        List: []ApplicationPermissionRecordItem{
                    dto.ApplicationPermissionRecordItem
                    {
