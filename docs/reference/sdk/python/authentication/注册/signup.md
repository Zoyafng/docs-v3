...
data = management_client.signup(
     ...
     profile: {
       ...
       address: "Hai Dian XX",
       formatted: "",
       street_address: "Hai Dian Street 1",
     ...
     options: {
       ...
       phone_pass_code_for_information_completion: "1234",
       email_pass_code_for_information_completion: "1234",
       context: {
