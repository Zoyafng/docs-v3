...
namespace Example
{
    class Program
    {
      ...
      private static async Task MainAsync()
      {
          ...
          ResignUserRespDto  result = await managementClient.ResignUser
          (  new ResignUserReqDto{                  UserId= "6229ffaxxxxxxxxcade3e3d9" ,
                  UserIdType= ResignUserReqDto.userIdType.USER_ID ,
            }
          );
        }
    }
