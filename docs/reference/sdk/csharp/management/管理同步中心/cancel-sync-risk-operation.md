...
| ---- | ---- | ---- | ---- | ---- | ---- |
| syncRiskOperationIds | array[] | 是 | - | 同步任务风险操作 ID  | `[1,2]` |
...
namespace Example
{
    class Program
    {
      ...
      private static async Task MainAsync()
      {
          ...
          CancelSyncRiskOperationsRespDto  result = await managementClient.CancelSyncRiskOperation
          (  new CancelSyncRiskOperationDto{                  SyncRiskOperationIds= new List<string>{"1","2",} ,
            }
          );
        }
    }
