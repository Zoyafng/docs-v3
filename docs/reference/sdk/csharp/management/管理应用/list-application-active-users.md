...
namespace Example
{
    class Program
    {
      ...
      private static async Task MainAsync()
      {
          ...
          UserPaginatedRespDto  result = await managementClient.ListApplicationActiveUsers
          (  new ListApplicationActiveUsersDto{                  AppId= "6229ffaxxxxxxxxcade3e3d9" ,
                Options= new ListApplicationActiveUsersOptionsDto
                {
