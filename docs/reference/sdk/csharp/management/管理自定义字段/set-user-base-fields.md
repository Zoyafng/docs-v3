...
namespace Example
{
    class Program
    {
      ...
      private static async Task MainAsync()
      {
          ...
          CustomFieldListRespDto  result = await managementClient.SetUserBaseFields
          (  new SetUserBaseFieldsReqDto{                List= new List<SetUserBaseFieldDto>
                {
                    new SetUserBaseFieldDto
                    {
                     Key= "school" ,
            Label= "学校" ,
            Description= "学校" ,
