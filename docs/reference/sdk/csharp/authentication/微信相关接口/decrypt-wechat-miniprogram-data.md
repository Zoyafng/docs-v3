...
namespace Example
{
    class Program
    {
      ...
      private static async Task MainAsync()
      {
          ...
          DecryptWechatMiniProgramDataRespDto  result = await managementClient.DecryptWechatMiniprogramData
          (  new DecryptWechatMiniProgramDataDto{                  ExtIdpConnidentifier= "my-wxapp" ,
                  EncryptedData= "" ,
                  Iv= "" ,
                  Code= "" ,
            }
