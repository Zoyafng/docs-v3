...
class Test {
    public static void main(String[] args) {
        ...
        EnrollFactorDto request = new EnrollFactorDto();
        request.setFactorType(EnrollFactorDto.factorType.SMS);
        request.setEnrollmentToken("TQoCISidM0kBji0dxRi3afSDtkvvMiUphenIgLF87y+JOw4T8fDWOsHHXIcvZ2EVESXhTrfGyh1iGf52Cg9e9byeFQvm1VZ0QWrwmzwpntFAVtf1IP9LqVhmzXhBMFvLOcU/z1Eh/n0CrwX0uHNpJoMW9lp9AqHd9HvauaGKX+Y=");
            EnrollmentData= new EnrollFactorEnrollmentDataDto(
                    request.setPassCode("123456");
        ),
        
        EnrollFactorRespDto response = managementClient.enrollFactor(request);
