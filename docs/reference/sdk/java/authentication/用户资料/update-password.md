...
class Test {
    public static void main(String[] args) {
        ...
        request.setNewPassword("undefined");
        request.setOldPassword("undefined");
        request.setPasswordEncryptType(UpdatePasswordDto.passwordEncryptType.NONE);
        
        CommonResponseDto response = managementClient.updatePassword(request);
