...
class Test {
    public static void main(String[] args) {
        ...
        GetWechatMiniProgramPhoneDto request = new GetWechatMiniProgramPhoneDto();
        request.setExtIdpConnidentifier("my-wxapp");
        request.setCode("");
        
        GetWechatMiniProgramPhoneRespDto response = managementClient.getWechatMiniprogramPhone(request);
