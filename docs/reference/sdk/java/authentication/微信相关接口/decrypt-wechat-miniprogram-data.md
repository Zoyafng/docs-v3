...
class Test {
    public static void main(String[] args) {
        ...
        DecryptWechatMiniProgramDataDto request = new DecryptWechatMiniProgramDataDto();
        request.setExtIdpConnidentifier("my-wxapp");
        request.setEncryptedData("");
        request.setIv("");
        request.setCode("");
        
        DecryptWechatMiniProgramDataRespDto response = managementClient.decryptWechatMiniprogramData(request);
