...
class Test {
    ...
    public static void main(String[] args) {
        ...
        request.setEndTime("20220802"); 
        request.setStartTime("20220202");
        CostGetMauPeriodUsageHistoryRespDto response = managementClient.getMauPeriodUsageHistory(request);
