...
class Test {
    ...
    public static void main(String[] args) {
        ...
        request.setScene(UpdatePipelineOrderDto.scene.PRE_REGISTER);
        request.setOrder(new List<String>());
        
        CommonResponseDto response = managementClient.updatePipelineOrder(request);
