...
class Test {
    ...
    public static void main(String[] args) {
        ...
        request.setTargetType(GetResourceAuthorizedTargetsDto.targetType.USER);
        request.setPage(1);
        request.setLimit(10);
        
        GetResourceAuthorizedTargetRespDto response = managementClient.getResourceAuthorizedTargets(request);
