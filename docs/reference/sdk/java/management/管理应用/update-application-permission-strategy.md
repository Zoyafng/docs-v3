...
class Test {
    ...
    public static void main(String[] args) {
        ...
        request.setPermissionStrategy(UpdateApplicationPermissionStrategyDataDto.permissionStrategy.ALLOW_ALL);
        
        IsSuccessRespDto response = managementClient.updateApplicationPermissionStrategy(request);
