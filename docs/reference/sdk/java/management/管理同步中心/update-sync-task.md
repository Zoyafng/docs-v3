...
class Test {
    ...
    public static void main(String[] args) {
        ...
        request.setSyncTaskType(UpdateSyncTaskDto.syncTaskType.LARK);
    ...
    request.setPassword("");
        ...
        request.setSyncTaskFlow(UpdateSyncTaskDto.syncTaskFlow.UPSTREAM);
        request.setSyncTaskTrigger(UpdateSyncTaskDto.syncTaskTrigger.MANUALLY);
    ...
    request.setStartTime(1664249726701);
        ...
        SyncTaskPaginatedRespDto response = managementClient.updateSyncTask(request);
