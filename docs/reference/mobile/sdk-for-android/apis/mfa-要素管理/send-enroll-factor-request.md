...
factorProfile.setPhoneCountryCode("+86");
factorProfile.setPhoneNumber("188xxxx8888");
authClient.sendEnrollFactorRequest(FactorType.SMS, factorProfile, (AuthCallback) response -> {
...
| otpData |  | 否 | 发起绑定 OTP 类型认证要素时，接口会返回此数据。<br/>参考：<a href="#otpData">otpData</a>。 |  |


### <a id="otpData"></a> otpData
